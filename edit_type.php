	...
	if($_SESSION["TYPE"] == "")
	{
		...
		if(isset($_REQUEST["btnSave"])){
			...
			if(mysqli_query($con,$Query)== TRUE){
				header("Location: product_type.php?Err=3");
			}
			else{
				header("Location: edit_type.php?Error=1");
			}
		}
?>
<!doctype html>
	...
	<?php
			...
			?>
                ...
                <form method="post" class="form-horizontal">
                         <?php
							$Query1="SELECT * FROM product_type WHERE type_id = '".$_REQUEST["ID"]."'";
					...
					?>
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="Name" value="<?=$arr["type_name"]?>" placeholder="Type Name" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                          </div>
