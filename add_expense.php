<?php
	...
	if(isset($_REQUEST["btnSave"])){
		...
		if(mysqli_query($con,$Query)== TRUE){
			header("Location: expense.php?Err=1");
		}
		else{
			...
			?>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="Amount" placeholder="Expense Amount" class="form-control"><small class="form-text text-muted">Enter Expense Amount here</small></div>
                          </div>
