			...
			?>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="Name" placeholder="Category Name" class="form-control"><small class="form-text text-muted">Enter Category Name here</small></div>
                          </div>
						  <div class="row form-group">
