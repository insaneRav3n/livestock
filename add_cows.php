...
include("include/db.php");
	...
	if(isset($_REQUEST["btnSave"])){
		...
		$Query = "INSERT INTO cow
		(cow_tag_no, color,horn,bread,age,weight,gender,cow_image,cat_id,product_type_id,ftag,mtag,pur_d,sold,status,pgstat)
    ...
    //  echo mysqli_error($con);
				header("Location: add_cows.php?Error=1");
		}
	}
			...
			?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Add Animal</strong>
                        </div>
                        <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="Tag_No" placeholder="Tag No" class="form-control"><small class="form-text text-muted">Enter Tag No here</small></div>
                          </div>
						  
						  <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Color</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="Color" placeholder="Color" class="form-control"><small class="form-text text-muted">Enter Color here</small></div>
                          </div>
                          ...
                          <div class="row form-group">
							...
							<select name="Horn" class="form-control">
                                <option>Please Select Horn Status</option>
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Father</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="Father" placeholder="Father Tag" class="form-control"><small class="form-text text-muted">Enter Father Tag here</small></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Mother</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="Mother" placeholder="Mother Tag" class="form-control"><small class="form-text text-muted">Enter Mother Tag here</small></div>
                          </div>
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="Age" placeholder="Age" class="form-control"><small class="form-text text-muted">Enter Age here</small></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="date" name="Date" placeholder="Text" class="form-control"><small class="form-text text-muted">Select Date here</small></div>
                          </div>					  
