<?php
	...
	if(isset($_REQUEST["btnSave"])){
		...
		if(mysqli_query($con,$Query)== TRUE){
			header("Location: doctor.php?Err=3");
		}
		else{
				header("Location: edit_doctor.php?Error=1");
		}
	}
?>
<!doctype html>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						?>
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="CNIC" placeholder="Aadhar No" value="<?=$arr["cnic"]?>" class="form-control"><small class="form-text text-muted">Enter Aadhar here</small></div>
                          </div>
						  <div class="row form-group">
