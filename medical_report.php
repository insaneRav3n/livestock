					...
					<div class="card">
						<div class="card-body">
                            ...
                            <div class="col-12 col-md-9">
								...
								<small class="form-text text-muted">Select Animal Tag here</small>
							</div>
                          </div>
			    ...
			    <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="col-md-6"><strong class="card-title">Medical Report</strong></div>
					...
					<?php
							if(isset($_REQUEST["btnSearch"])){
								$Query="SELECT * FROM medical WHERE cow LIKE '%".$_REQUEST["Cow"]."%'";
