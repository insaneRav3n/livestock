                ...
                <div class="col-md-12">
                    <div class="card">
                       <div class="card-header">
                            <strong class="card-title">Purchases Detail</strong>
							<a href="add_purchase.php" class="btn btn-success" style="margin-left:60%;"><i class="fa fa-plus"></i>Add Purchases</a>
                        </div>
                        <div class="card-body">
