				...
				<div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="col-md-6"><strong class="card-title">Feed Report</strong></div>
                   ...
                   <table id="bootstrap-data-table" class="table table-striped table-bordered">
					...
					if(isset($_REQUEST["btnSearch"])){
							$Query1="SELECT * FROM feed WHERE  feed_cow LIKE '%".$_REQUEST["Cow"]."%'";
							$rst=mysqli_query($con,$Query1);
							while($arr=mysqli_fetch_array($rst)){
					?>
                      <tr>
                        <td><?=$arr["feed_id"]?></td>
                        <td><?=$arr["feed_cow"]?></td>
                        <td><?=$arr["feed_sealage"]?></td>
                        <td><?=$arr["feed_wanda"]?></td>
                        <td><?=$arr["feed_date"]?></td>
                        <td><?=$arr["feed_time"]?></td>
					  </tr>
					  <?php
