                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form method="POST" action="sales_report.php" class="form-control">
                    ...
                    <tr>
                        ...
                        <td>	
							...
							<a href="sales.php?Delete&ID=<?=$arr["sale_id"]?>" class="btn btn-danger btn-sm" ><i class="fa fa-trash"></i>Delete </a>
						</td>
                    </tr>
                    <?php
						}}
