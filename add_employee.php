<?php
	...
	if(isset($_REQUEST["btnSave"])){
		...
		(employee_name, mobile_no, address, cnic, img)
			...
			?>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="Name" placeholder="Employee Name" class="form-control"><small class="form-text text-muted">Enter Employee Name here</small></div>
                          </div>
						  <div class="row form-group">
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="CNIC" placeholder="Aadhar No" class="form-control"><small class="form-text text-muted">Enter Aadhar no here</small></div>
                          </div>
						  <div class="row form-group">
