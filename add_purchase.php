<?php
	...
	if(isset($_REQUEST["btnSave"])){
		...
		(purchase_cow,purchase_date,purchase_amount)
		VALUES ('".$_REQUEST["Name"]."',
				'".$_REQUEST["Date"]."',
				'".$_REQUEST["Amount"]."')";
	if(mysqli_query($con,$Query)== TRUE){
			header("Location: purchase.php?Err=1");
		}
		else{
				header("Location: add_purchase.php?Error=1");
		}
	}
?>
<!doctype html>
			...
			?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Add Purchase</strong>
                        </div>
                        <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="Amount" placeholder="Purchase Amount" class="form-control"><small class="form-text text-muted">Enter Purchase Amount here</small></div>
                          </div>
