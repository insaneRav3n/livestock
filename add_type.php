<?php
	...
	if(isset($_REQUEST["btnSave"])){
		...
		if(mysqli_query($con,$Query)== TRUE){
			header("Location: product_type.php?Err=1");
		}
		else{
				header("Location: add_type.php?Error=1");
		}
	}
			...
			?>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="Name" placeholder="Type Name" class="form-control"><small class="form-text text-muted">Enter Type Name here</small></div>
                          </div>
						  <div class="row form-group">
